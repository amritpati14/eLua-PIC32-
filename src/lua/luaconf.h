...
** ===================================================================
*/
// Enable the LTR on all platforms for the PIC32 port, this includes other platforms that may be
// used to cross compile scripts.
...
#if !defined(LUA_CROSS_COMPILER)
// stdint.h can be used to provide the necessary definitions of these types.
